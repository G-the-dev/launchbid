...
const RULES = [
  ...
  "Bids start at 5 ⚡. Spawning your first product earns a 25 ⚡ welcome bonus.",
  ...
  "Earning caps: the share quest pays once per player, explore quests pay for up to 10 visits a day, and your own products never pay you.",
