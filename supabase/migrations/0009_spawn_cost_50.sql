-- Spawning now costs 50 tokens: one verified share covers exactly one listing.
...
begin
  ...
  update profiles set token_balance = token_balance - 50
   where id = v_user and token_balance >= 50
